...
#             LIBS := -L$(NETCDF_LIBDIR) -lnetcdf
    NETCDF_INCDIR ?= /home/cae/local/netcdf-3.6.3_pgi/include
    NETCDF_LIBDIR ?= /home/cae/local/netcdf-3.6.3_pgi/lib
             LIBS := -L$(NETCDF_LIBDIR) -lnetcdf
endif
...
ifdef USE_ARPACK
 ifdef USE_MPI
   PARPACK_LIBDIR ?= /home/csouzata/WS/TRUNK_JUL2013/Lib/ARPACK
             LIBS += $(PARPACK_LIBDIR)/libparpack-mpif90.a
#  PARPACK_LIBDIR ?= /opt/pgisoft/PARPACK
#            LIBS += -L$(PARPACK_LIBDIR) -lparpack
 endif
    ARPACK_LIBDIR ?= /home/csouzata/WS/TRUNK_JUL2013/Lib/ARPACK
             LIBS += $(ARPACK_LIBDIR)/libarpack-mpif90.a
